...
* introduce Flask-Storage to your friends, let Flask-Storage to be known
* discuss Flask-Storage , and submit bugs with github issues
* improve documentation for Flask-Storage
...
The codebase of Flask-Storage is highly tested and :pep:`8` compatible, as a way
